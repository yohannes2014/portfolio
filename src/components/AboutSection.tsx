  ...
  return (
    <div className='lg:w-[1120px] m-auto' >
      ...
      <div className='grid grid-cols-2 grid-rows-2 font-semibold bg-slate-100 rounded-2xl mx-4'>
        <div className='col-start-1 col-end-3 row-start-1 row-end-2 flex justify-center items-center px-2'>
        ...
        <div className='col-start-1 col-end-3 row-start-2 row-end-3 flex justify-center items-center'>
